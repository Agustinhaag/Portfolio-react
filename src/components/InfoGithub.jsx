  ...
  return (
    <div className="flex flex-col items-center md:w-4/5 w-full my-2 ">
        <div className="flex flex-col items-center w-full gap-2 ">
          <div className={`md:w-full  bg-opacity-70  ${mode ?"bg-black":"bg-neutral-600"} px-2 py-4 rounded flex gap-5 md:mr-3 w-[98%] md:mx-0 mx-auto`}>
            <img
              src={user.avatar_url}
              alt={user.name}
            ...
            <div className="flex flex-col gap-1 justify-center items-start">
              <h4 className={`sm:text-3xl text-2xl text-center text-white`}>{user.name}</h4>
              <p className={`${mode ?"text-neutral-400":"text-neutral-200"} sm:text-sm text-xs lg:w-full md:w-4/5 w-full`}>
                {user.bio}
              </p>
            </div>
          </div>
          ...
          <div className="w-full md:pl-0 pl-3">
            <div className="flex custom:flex-row flex-col  sm:gap-0 custom:gap-2 gap-4 text-start pt-3 custom:pb-5 pb-0">
              <div className="w-1/2 flex flex-col">
                <p className={`font-light flex items-center gap-1  ${mode ?"text-neutral-400" :"text-neutral-500"}`}>
